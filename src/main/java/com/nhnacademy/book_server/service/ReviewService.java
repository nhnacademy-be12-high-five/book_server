...
public interface ReviewService {
    ReviewCreateResponse saveReview(ReviewCreateRequest request, Long bookId, Long memberId);
    ...
    UpdateReviewResponse updateReview(ReviewUpdateRequest request, Long reviewId, Long memberId, List<MultipartFile> images);
}
